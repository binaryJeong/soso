...
<section>
    <div class='middle' style="background-color: white; height: auto">
        ...
        <article style="margin-bottom: 50px">
            <img src="../image/title.png" style="height:50px; margin-bottom:180px; margin-left: 100px; margin-top: 20px">
            <img src="../image/nas_img.png" style="height:200px; margin-left: 450px;margin-top: 20px">
            <div class="block"
                 style="background-color:white ; width: 1000px; color: black; margin-left: 100px; margin-top: 0px">
                ...
                <div class="main">
                    ...
                    <img src="../image/all.png" style="height:250px; margin-right:450px;margin-top:30px;margin-bottom:10px">
                    <div class="content" style="">
                        <div id="container">
                            <div id="input-form" style="font-weight: bold;font-size: 20px">
                                Searh : <input type="text" id="keyword"
